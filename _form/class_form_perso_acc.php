...
class class_form_perso_acc extends class_form{
	...
	function afterUpdate(){
		if($this->qry->rec_kartennummer!=$this->oVals->kartennummer)$this->delKarte($this->oVals->kartennummer);
	...
	function delKarte($kartnum=null){
		...
		$qZKM=new clsAdoacc($this->qry->get_dbLink(),$strSql);
		$qZKM->open(null,null);
