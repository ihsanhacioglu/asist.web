<?php
class class_pratik_hedef_acikla extends class_pratik{
	function formtam(){
		global $oUser;
		...
		//$qCCC->prm_hedef_id=$this->qry->rec_id;
	...
	function hedef_durum($doran){
		$dur1=-54301;
		    if($doran<0)	$dur1=-54306; // 6. Hedef İptal Edildi
		elseif($doran==0)	$dur1=-54301; // 1. Hedef Henüz Başlamadı
		elseif($doran<100)	$dur1=-54302; // 2. Hedef Devam Ediyor
		elseif($doran>=100)	$dur1=-54303; // 3. Hedef Tamamlandı
		return $dur1;
	}
}
?>