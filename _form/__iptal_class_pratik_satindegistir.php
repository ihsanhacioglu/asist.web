...
class class_pratik_satindegistir extends class_pratik{
	function formtam(){
		$this->qry->close();
        ...
        $qCCC->prm_durum = -21601; // Form hazýrlanýyor
        $qCCC->prm_dtarih= $this->objVal("ozaman","bugun");
        $qCCC->prm_dsaat = $this->objVal("ozaman","busaat");
		$qCCC->exec();

		$this->strMessage="Talep üzerinde artýk deðiþiklik yapabilirsiniz";
		$this->formMessage();
	}
}
?>
