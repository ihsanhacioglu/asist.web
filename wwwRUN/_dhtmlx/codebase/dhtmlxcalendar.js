...
function dhtmlxCalendarObject (contId, butId, isAutoDraw, options){
	...
	defTr = {
	    langname:      'tr',
	    dateformat:    '%Y.%m.%d',
	    monthesFNames: ["Ocak", "Þubat", "Mart", "Nisan", "Mayýs", "Haziran", "Temmuz", "Aðustos", "Eylül", "Ekim", "Kasým", "Aralýk"],
	    monthesSNames: ["Oca", "Þub", "Mar", "Nis", "May", "Haz", "Tem", "Aðu", "Eyl", "Eki", "Kas", "Ara"],
	    daysFNames:    ["Pazar", "Pazartesi", "Salý", "Çarþamba", "Perþembe", "Cuma", "Cumartesi"],
	    daysSNames:    ["Pa", "Pt", "Sa", "Ça", "Pe", "Cu", "Ct"],
	    weekend:       [0, 6],
	    weekstart:     1,
	    msgClose:      "Kapat",
	    msgMinimize:   "Küçült",
